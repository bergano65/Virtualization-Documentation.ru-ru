...
С помощью PowerShell Direct можно запускать произвольный код PowerShell на виртуальной машине с Windows10 или Windows Server Technical Preview с узла Hyper-V независимо от конфигурации сети и параметров удаленного управления.
...
* Узел: Windows10, Windows Server Technical Preview2 или более поздней версии с Hyper-V.
* Гость/виртуальная машина: Windows10, Windows Server Technical Preview2 или более поздней версии.
