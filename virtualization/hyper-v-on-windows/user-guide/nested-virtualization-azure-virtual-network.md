# <a name="configuring-nested-vms-to-communicate-directly-with-resources-in-an-azure-virtual-network"></a>Настройка вложенных виртуальных машин связываться напрямую по ресурсов в Azure виртуальной сети
