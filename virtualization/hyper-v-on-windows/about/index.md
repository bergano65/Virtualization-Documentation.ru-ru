...
> Обновите операционную систему Windows 10 Home Edition до Windows 10 Pro, открыв обновление **параметров** > **и** > **активацию**безопасности. Здесь вы можете посетить Store и приобрести обновление.
