# [Обзор](./index.md)
# [API платформы низкоуровневой оболочки Windows](./hypervisor-platform/hypervisor-platform.md)
...
### [Типы данных](./hypervisor-platform/funcs/WHvPartitionPropertyDataTypes.md)
...
### [Типы данных](./hypervisor-platform/funcs/WHvVirtualProcessorDataTypes.md)
...
### [Контекст выхода](./hypervisor-platform/funcs/WHvExitContextDataTypes.md)
### [Доступ к памяти](./hypervisor-platform/funcs/MemoryAccess.md)
### [Доступ к портам ввода-вывода](./hypervisor-platform/funcs/IOPortAccess.md)
### [Доступ к MSR](./hypervisor-platform/funcs/MSRAccess.md)
### [Доступ к CPUID](./hypervisor-platform/funcs/CPUIDAccess.md)
### [Исключение виртуального процессора](./hypervisor-platform/funcs/VirtualProcessorException.md)
### [Окно прерывания](./hypervisor-platform/funcs/InterruptWindow.md)
### [Неподдерживаемая функция](./hypervisor-platform/funcs/UnsupportableFeature.md)
### [Отмена выполнения](./hypervisor-platform/funcs/ExecutionCancelled.md)
...
# [Эмулятор инструкций низкоуровневой оболочки](./hypervisor-instruction-emulator/hypervisor-instruction-emulator.md)
## Эмуляция инструкций
### [Доступ к портам ввода-вывода](./hypervisor-instruction-emulator/funcs/IOPortAccessIE.md)
### [Доступ к MMIO](./hypervisor-instruction-emulator/funcs/MMIOAccessIE.md)
## Структуры эмулятора
...
# [API поставщика дампов сохраненного состояния виртуальной машины](./vm-dump-provider/vm-dump-provider.md)
