...
Принцип работы контейнеров хорошо объясняется в [этой записи блога](http://azure.microsoft.com/blog/2015/08/17/containers-docker-windows-and-trends/) Марка Руссиновича.
