...
**Важное примечание.** *В настоящее время режим мелких объектов и сеть наложения доступны только [участникам программы предварительной оценки Windows](https://insider.windows.com/) в рамках предстоящего обновления Windows 10 для дизайнеров. Поддержка для других платформ Windows станет доступна в ближайшее время.*
