# Экземпляры контейнеров Windows

Это коллекция образцов и примеров, отправленных командой Windows и членами сообщества.  Эти примеры представлены "как есть" и не сопровождаются никакими гарантиями.  Вы можете присылать дополнительные примеры или улучшать имеющиесяа.
