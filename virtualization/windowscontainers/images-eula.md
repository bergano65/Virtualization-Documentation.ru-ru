...
Как часть дополнительные условия лицензионного соглашения для этого образа ОС контейнера для контейнеров Windows, вы облагаются также базовое Windows Server узла условия лицензионного соглашения, которые расположены по адресу: https://www.microsoft.com/en-us/useterms.  
