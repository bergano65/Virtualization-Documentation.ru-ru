...
ms.locfileid: "9576872"
---
# <a name="optimize-windows-dockerfiles"></a>Оптимизация файлов Dockerfile в Windows

Чтобы оптимизировать процесс сборки Docker и получаемые образы Docker, можно использовать несколько методов. Этот документ описывает работу процесса сборки Docker и предлагает несколько методик оптимизировать, которые могут использоваться для образов создание с контейнерами Windows.
